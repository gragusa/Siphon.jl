...
const fkf_at_first10 = [1120.0, 1120.0, 1123.3640894301147, 1100.1322949354128,
                        1120.689614058128, 1129.105786767722, 1136.2243333621434,
                        1058.6623178789882, 1100.715153023627, 1167.6439427329178]
const fkf_at_last5 = [907.2004994420702, 910.1801224150503, 861.6505846700672,
                      824.365695204029, 803.0615762434667]

# Predicted variances Pt[,,t] = Var[α_t | y_{1:t-1}]
const fkf_Pt_first10 = [100.0, 1400.125467798218, 2583.1488137544575, 3509.7075078221296,
                        4153.784032169073, 4565.25501622511, 4814.120467776086,
                        4959.684698730231, 5043.164980325884, 5090.500040863827]

# Filtered states att[,t] = E[α_t | y_{1:t}]
const fkf_att_first10 = [1120.0, 1123.3640894301147, 1100.1322949354128, 1120.689614058128,
                         1129.105786767722, 1136.2243333621434, 1058.6623178789882,
                         1100.715153023627, 1167.6439427329178, 1160.7248944698297]
const fkf_att_last5 = [907.2004994420702, 910.1801224150503, 861.6505846700672,
                       824.365695204029, 803.0615762434667]

# Filtered variances Ptt[,,t] = Var[α_t | y_{1:t}]
const fkf_Ptt_first10 = [99.3484396656165, 1282.3717856218557, 2208.930479689528,
                         2853.007004036471, 3264.4779880925084, 3513.3434396434845,
                         3658.9076705976295, 3742.387952193283, 3789.7230127312255,
                         3816.390345069674]
const fkf_Ptt_100 = 3850.3845142427253

# Innovations vt[,t] = y_t - E[y_t | y_{1:t-1}]
const fkf_vt_first10 = [0.0, 40.0, -160.36408943011475, 109.8677050645872, 39.31038594187203,
                        30.894213232277934, -323.2243333621434, 171.33768212101177,
                        269.28484697637305, -27.64394273291782]

# Innovation variances Ft[,,t] = Var[y_t | y_{1:t-1}]
const fkf_Ft_first10 = [15347.7728343637, 16647.89830216192, 17830.921648118157,
                        18757.48034218583, 19401.556866532774, 19813.027850588813,
                        20061.893302139786, 20207.457533093933, 20290.937814689583,
                        20338.27287522753]

# Kalman gains Kt[,,t]
const fkf_Kt_first10 = [0.0065156033438349935, 0.08410223575286951, 0.14486905751319246,
                        0.18710975268510607, 0.21409539763967356, 0.23041682728414667,
                        0.2399634169753368, 0.2454383333780467, 0.2485427251506776,
                        0.25029165810161635]

# Nile data
const nile_Y = [1120.0, 1160.0, 963.0, 1210.0, 1160.0, 1160.0, 813.0, 1230.0, 1370.0, 1140.0,
...
const fkf_na_at_first15 = [1120.0, 1120.0, 1123.5750503019735, 1123.5750503019735,
                           1142.0844759831643, 1146.279488101204, 1149.6506377958817,
                           1064.742569925566, 1107.0217591553153, 1174.8280519639382,
                           1174.8280519639382, 1119.793956485756, 1067.2207231992086,
                           1078.9121347544572, 1056.2123426414194]

const fkf_na_at_last5 = [906.3743167946249, 909.6604839598359, 859.7757863151869,
                         821.8337918361999, 800.5343884405607]

# Predicted variances
const fkf_na_Pt_first15 = [100.0, 1484.409192036385, 2736.804297745189, 4121.870341710042,
                           4624.165229614517, 4926.459195251042, 5101.087062097229,
                           5199.586565399375, 5254.398930507148, 5284.671090115226,
                           6669.73713408008, 6013.614685801527, 5687.828417361774,
                           5518.432865524594, 5428.24123048511]

# Filtered states
const fkf_na_att_first15 = [1120.0, 1123.5750503019735, 1123.5750503019735,
                            1142.0844759831643, 1146.279488101204, 1149.6506377958817,
                            1064.742569925566, 1107.0217591553153, 1174.8280519639382,
                            1174.8280519639382, 1119.793956485756, 1067.2207231992086,
                            1078.9121347544572, 1056.2123426414194, 1046.6480292688207]

const fkf_na_att_last5 = [906.3743167946249, 909.6604839598359, 859.7757863151869,
                          821.8337918361999, 800.5343884405607]

# Filtered variances
const fkf_na_Ptt_first15 = [99.34314807153144, 1351.7382537803355, 2736.804297745189,
                            3239.0991856496626, 3541.393151286188, 3716.021018132376,
                            3814.5205214345215, 3869.3328865422945, 3899.605046150373,
                            5284.671090115226, 4628.548641836674, 4302.76237339692,
                            4133.36682155974, 4043.175186520256, 3994.547732538421]

const fkf_na_Ptt_100 = 3936.454198447892

# Nile data with NA at positions 3 and 10
const nile_Y_na = [1120.0, 1160.0, NaN, 1210.0, 1160.0, 1160.0, 813.0, 1230.0, 1370.0, NaN,
                   995.0, 935.0, 1110.0, 994.0, 1020.0, 960.0, 1180.0, 799.0, 958.0, 1140.0,
                   1100.0, 1210.0, 1150.0, 1250.0, 1260.0, 1220.0, 1030.0, 1100.0, 774.0, 840.0,
                   874.0, 694.0, 940.0, 833.0, 701.0, 916.0, 692.0, 1020.0, 1050.0, 969.0,
                   831.0, 726.0, 456.0, 824.0, 702.0, 1120.0, 1100.0, 832.0, 764.0, 821.0,
